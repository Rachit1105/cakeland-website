...
import { FaWhatsapp, FaInstagram, FaSearch, FaHome, FaBook } from 'react-icons/fa';
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-pink-200 via-pink-100 to-white flex flex-col items-center justify-center relative overflow-hidden transition-colors duration-1000">
      ...
      <div className="fixed top-0 left-0 right-0 bg-[#E46296] h-20 md:h-24 z-40 shadow-lg flex items-center justify-between px-6 md:px-10">
        ...
        <nav className="flex items-center gap-5 text-white">
          <Link
            href="/explore"
            className="font-semibold uppercase text-sm tracking-wide hover:underline transition flex items-center gap-2"
          >
            <FaSearch size={16} />
            Explore
          </Link>
      ...
      {introComplete && (
        <div className="relative z-10 flex flex-col items-center justify-center flex-1 w-full max-w-5xl px-4 py-8 pt-28 md:pt-32">
          ...
          <div className="text-center mt-20 md:mt-16 relative w-full">
            ...
            {/* Carousel Container */}
            <div className="relative overflow-visible min-h-[550px] md:min-h-[600px] flex items-center justify-center">
